...
def convert_to_canonical(formulation: ProblemFormulation, is_gold: bool) -> CanonicalFormulation:
    ...
    # Flip the sign if the objective direction is maximize
    if formulation.objective.direction == OBJ_DIR_MAXIMIZE:
        objective *= -1
    elif formulation.objective.direction == OBJ_DIR_MINIMIZE:
        # do nothing
        objective = objective
    else:
